...
class LinearController(Controller):
    ...
    def act(self, x, t, alpha=None):
        nominal_control = self.nominal_control if self.time_invariant else self.nominal_control[
            t]
        nominal_state = self.nominal_state if self.time_invariant else self.nominal_state[t]
...
class LinearControllerWithFeedForwardAndNoOffset(Controller):
    ...
    def act(self, x, t, alpha=1.0):
        ...
        return (1-alpha) * nominal_control + alpha * k + K @ (x - (1-alpha) * nominal_state)
